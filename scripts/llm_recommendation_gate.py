# -*- coding: utf-8 -*-
"""
שער LLM: האם שיתוף VCF בצ'אט הוא המלצה על בעל מקצוע/עסק, ומה תחום העיסוק.
...
"""
    if hybrid:
        return base + """מצב hybrid: החלט **רק** האם שיתוף הכרטיס הוא המלצה מקצועית (בעל מקצוע / עסק / נותן שירות). לא לקבוע תחום עיסוק.
...
דוגמאות תקינות:
{"include":false,"reason":"שיתוף ללא בקשה להמלצה מקצועית"}
{"include":true,"reason":"מבקשים המלצה לאינסטלטור"}
"""
    return base + """החלט:
1) האם מדובר בהמלצה על בעל מקצוע / עסק / נותן שירות, לעומת איש קשר אישי או שיתוף בלי המלצה?
2) אם כן — מה תחום העיסוק בעברית (קטגוריה קצרה).

חובה: החזר **אובייקט JSON יחיד בלבד** — בלי טקסט לפני או אחרי. המפתחות באנגלית: "include", "field", "reason" (הסיבה בעברית).

דוגמאות:
{"include":false,"field":"","reason":"אין הקשר מקצועי"}
{"include":true,"field":"חשמל","reason":"מחפשים חשמלאי"}
